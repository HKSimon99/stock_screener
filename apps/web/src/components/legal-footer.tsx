  ...
  return (
    <footer className="app-shell mt-8 pb-28 md:pb-10">
      <div className="surface-panel rounded-xl px-5 py-4">
        <p className="text-[0.72rem] leading-relaxed text-quiet">
          <span className="font-semibold text-white">투자 정보 제공 목적</span>
          ...
          &nbsp;
          <Link href="/disclosures" className="inline-flex min-h-6 items-center font-semibold text-[oklch(0.78_0.13_231)] underline-offset-2 hover:underline">
            상세 고지 보기
          </Link>
        </p>
      </div>
