...
export function LegalFooter() {
  return (
    <footer className="app-shell mt-8 pb-28 md:pb-10">
      <div className="rounded-[1.25rem] border border-white/6 bg-white/[0.025] px-5 py-4">
        <p className="text-[0.68rem] leading-relaxed text-faint">
          <span className="font-medium text-quiet">⚠ 투자 정보 제공 목적</span>
          ...
          &nbsp;
          <Link href="/disclosures" className="underline-offset-2 hover:text-white hover:underline">
            상세 고지 보기
          </Link>
        </p>
      </div>
